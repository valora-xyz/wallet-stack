...
Defined in: [packages/wallet-stack/src/public/getWalletClient.ts:12](https://github.com/divvi-xyz/divvi-mobile/blob/main/packages/wallet-stack/src/public/getWalletClient.ts#L12)
