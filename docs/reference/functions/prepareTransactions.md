...
Defined in: [packages/wallet-stack/src/public/prepareTransactions.ts:50](https://github.com/divvi-xyz/divvi-mobile/blob/main/packages/wallet-stack/src/public/prepareTransactions.ts#L50)
