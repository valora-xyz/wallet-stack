...
export default HomeFeed = () => {
  it('should show correct information on tap of feed item', async () => {
    ...
    // Assert on text based on elements returned earlier. Android's aggregated label
    // joins fields with `, ` while iOS uses spaces — split on both.
    const address = items.elements[0].label.split(/[\s,]+/)[0]
